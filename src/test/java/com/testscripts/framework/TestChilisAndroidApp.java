...
public class TestChilisAndroidApp extends Base {
	...
	@Test(priority = 1)
	public void TC01_ANDROID_APP_loginLogout_TestCase() throws Exception {
		Logger log = LogManager.getLogger("loginLogout_TestCase");
		log.info("******TC01_ANDROID_APP : Starting to login logout functionality in Chilis App******");
	...
	@Test(priority = 2)
	public void TC02_ANDROID_APP_validateLocationSearch_TestCase() throws Exception {
		Logger log = LogManager.getLogger("validateLocationSearch_TestCase");
		log.info("******TC02_ANDROID_APP : Starting to test Location Search Functionality of Chilis App******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
	...
	@Test(priority = 3)
	public void TC03_ANDROID_APP_validateRewards_SignedInUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("validateRewards_SignedInUser_TestCase");
		log.info("******TC03_ANDROID_APP : Starting to validate Rewards for sign in users******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
	...
	@Test(priority = 4)
	public void TC04_ANDROID_APP_validateChilisFavouriteItems_TestCase() throws Exception {
		Logger log = LogManager.getLogger("validateChilisFavouriteItems_TestCase");
		log.info("******TC04_ANDROID_APP : Starting to validate Chilis Favourite Items for sign in users******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
	...
	@Test(priority = 5)
	public void TC05_ANDROID_APP_loggedInUserOrder_TestCase() throws Exception {
		Logger log = LogManager.getLogger("loggedInUserOrder_TestCase");
		log.info("******TC05_ANDROID_APP : Starting to validate user is able to do order placement with existing logged in user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		...
		components.androidAppEnterPaymentDetails();
		components.androidAppPlaceOrder();
		components.androidAppvalidateOrderPlace();
	}
	@Test(priority = 6)
	public void TC06_ANDROID_APP_AddMyVisit_TestCase() throws Exception {
		Logger log = LogManager.getLogger("AddMyVisit_TestCase");
		log.info("******TC06_ANDROID_APP : Starting to verify user is able to submit Add my visit form for login member******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppAddVisitDetails();
		components.appretrieveAddVisitSuccessMessage();
	}
	@Test(priority = 7)
	public void TC07_ANDROID_APP_CurbsideOrder_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbsideOrder_GuestUser_TestCase");
		log.info("******TC07_ANDROID_APP : Starting to validate user is able to place Curbside order for guest user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateRestaurantSelection(3);
	...
	@Test(priority = 8)
	public void TC08_ANDROID_APP_CarryOutASAP_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutASAP_MCAUser_TestCase");
		log.info("******TC08_ANDROID_APP : Starting to validate user is able to do place Carry out ASAP order with MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	@Test(priority = 9)
	public void TC09_ANDROID_APP_CurbsideASAP_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbsideASAP_MCAUser_TestCase");
		log.info("******TC09_ANDROID_APP : Starting to validate user is able to do place Curbside ASAP order with MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	@Test(priority = 10)
	public void TC10_ANDROID_APP_CarryOutLaterToday_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutLaterToday_MCAUser_TestCase");
		log.info("******TC10_ANDROID_APP : Starting to validate user is able to do place Carry out Later Today order with MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	@Test(priority = 11)
	public void TC11_ANDROID_APP_CurbsideLaterToday_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbsideLaterToday_MCAUser_TestCase");
		log.info("******TC11_ANDROID_APP : Starting to validate user is able to do place Curbside Later Today order with MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	@Test(priority = 12)
	public void TC12_ANDROID_APP_DeliveryLaterToday_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("DeliveryLaterToday_MCAUser_TestCase");
		log.info("******TC12_ANDROID_APP : Starting to validate user is able to do place Delivery Later Today order with MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
		components.androidAppValidateMenuSelection(3);
		components.androidAppValidateCheckOut();
		components.androidAppEnterDeliveryDetails(3);
	...
	@Test(priority = 13)
	public void TC13_ANDROID_APP_DeliveryASAP_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("DeliveryASAP_MCAUser_TestCase");
		log.info("******TC13_ANDROID_APP : Starting to validate user is able to do place Delivery ASAP order with MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);    
	...
	@Test(priority = 14)
	public void TC14_ANDROID_APP_DeliveryLaterTodayOrder_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("DeliveryLaterTodayOrder_GuestUser_TestCase");
		log.info("******TC14_ANDROID_APP : Starting to validate user is able to place Delivery Later Today Order for guest user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateRestaurantSelection(3);
	...
	@Test(priority = 15)
	public void TC15_ANDROID_APP_DeliveryASAPOrder_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("DeliveryASAPOrder_GuestUser_TestCase");
		log.info("******TC15_ANDROID_APP : Starting to validate user is able to place Delivery ASAP Order for guest user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateRestaurantSelection(3);
	...
	@Test(priority = 16)
	public void TC16_ANDROID_APP_CurbsideItemCustomization_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbsideItemCustomization_MCAUser_TestCase");
		log.info("******TC16_ANDROID_APP : Starting to validate user is able to do place Curbside order Item Customization for MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	@Test(priority = 17)
	public void TC17_ANDROID_APP_CarryOutFutureDateOrder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutFutureDateOrder_MCAUser_TestCase");
		log.info("******TC17_ANDROID_APP : Starting to validate user is able to do place Carry out Future Date favourite Items order with MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	@Test(priority = 18)
	public void TC18_ANDROID_APP_CarryOutFutureOrderItemCustomization_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutFutureOrderItemCustomization_GuestUser_TestCase");
		log.info("******TC18_ANDROID_APP_Starting to validate user is able to place Carry Out Future Order item customization for Guest User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateRestaurantSelection(3);
		components.androidAppSelectMenuCategory();
	...
	@Test(priority = 19)
	public void TC19_ANDROID_APP_Reorder_TestCase() throws Exception {
		Logger log = LogManager.getLogger("Reorder_TestCase");
		log.info("******TC19_ANDROID_APP : Starting to verify user is able to place reorder******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	@Test(priority = 20)
	public void TC20_ANDROID_APP_UpdateMyAccount_TestCase() throws Exception {
		Logger log = LogManager.getLogger("UpdateMyAccount_TestCase");
		log.info("******TC20_ANDROID_APP : Starting to validate user is able to update my Account******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
	...
	@Test(priority = 21)
	public void TC21_ANDROID_APP_PlaceOrderWithRewards_TestCase() throws Exception {
		Logger log = LogManager.getLogger("PlaceOrderWithRewards_TestCase");
		log.info("******TC21_ANDROID_APP : Starting to validate user is able to place order with Rewards******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.androidAppClosePopUp();
		components.androidAppValidateLogin();
		components.androidAppValidateRestaurantSelectionforLoggedInUser(3);
	...
	public void TC26_ANDROID_APP_QA2_loggedInUserOrder_TestCase() throws Exception {
		...
		components.androidAppValidateCheckOut();
		components.androidAppContinueToPayment();
		components.androidAppEnterPaymentDetailswithSuggestedTip(4);
		components.androidAppPlaceOrder();
		components.androidAppvalidateOrderPlace();
	}
	@Test(priority = 27)
	...
	public void TC28_ANDROID_APP_QA2_CurbsideOrder_GuestUser_TestCase() throws Exception {
		...
		components.androidAppEnterVehicleDetails();
		components.androidAppContinueToPayment();
		components.androidAppEnterPaymentDetailswithCustomTip(3);
		components.androidAppPlaceOrder();
		components.androidAppvalidateOrderPlace();
	}
	@Test(priority = 29)
	public void TC29_ANDROID_APP_QA2_CarryOutASAP_MCAUser_TestCase() throws Exception {
		...
		components.androidAppSelectPickupAsap();
		components.androidAppContinueToPayment();
		components.androidAppEnterPaymentDetailswithSuggestedTip(3);
		components.androidAppPlaceOrder();
		components.androidAppvalidateOrderPlace();
	}
	@Test(priority = 30)
