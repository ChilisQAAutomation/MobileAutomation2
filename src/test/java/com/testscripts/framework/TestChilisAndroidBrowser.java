...
public class TestChilisAndroidBrowser extends Base {
	...
	@Test(priority = 1)
	public void TC01_ANDROID_BROWSER_LoginLogout_TestCase() throws Exception {
		Logger log = LogManager.getLogger("LoginLogout_TestCase");
		log.info(
				"******TC01_ANDROID_BROWSER : Starting to Validate Login and Logout functionality of Chilis WebApp******");
	...
	@Test(priority = 2)
	public void TC02_ANDROID_BROWSER_LoggedInUserOrder_TestCase() throws Exception {
		Logger log = LogManager.getLogger("LoggedInUserOrder_TestCase");
		log.info(
				"******TC02_ANDROID_BROWSER : Starting to validate user is able order placement with existing log in user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(2);
		components.validateChilisFavoriteItemsSelection(4);
		components.validateCheckOutPage();
		components.continueToPayment();
		components.enterPaymentDetails();
	...
	@Test(priority = 3)
	public void TC03_ANDROID_BROWSER_CurbsideASAPorder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbsideASAPorder_MCAUser_TestCase");
		log.info(
				"******TC03_ANDROID_BROWSER : Starting to validate user is able to place Curb side ASAP Order for MCA user*******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(7);
		components.validateChilisFavoriteItemsSelection(4);
		components.validateCheckOutPage();
	...
	@Test(priority = 4)
	public void TC04_ANDROID_BROWSER_CarryOutLaterTodayOrder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutLaterTodayOrder_MCAUser_TestCase");
		log.info(
				"******TC04_ANDROID_BROWSER : Starting to validate user is able to place Carry-out Later Today order for MCA user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
	...
	@Test(priority = 5)
	public void TC05_ANDROID_BROWSER_CurbSideLaterTodayOrder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbSideLaterTodayOrder_MCAUser_TestCase");
		log.info(
				"******TC05_ANDROID_BROWSER : Starting to validate user is able to place CurbSide Later Today order for MCA user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(3);
	...
	@Test(priority = 6)
	public void TC06_ANDROID_BROWSER_CarryOutASAPOrder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutASAPOrder_MCAUser_TestCase");
		log.info(
				"******TC06_ANDROID_BROWSER : Starting to validate user is able to place Carry Out ASAP order for MCA user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(3);
	...
	@Test(priority = 7)
	public void TC07_ANDROID_BROWSER_DeliveryASAPOrder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("DeliveryASAPOrder_MCAUser_TestCase");
		log.info(
				"******TC07_ANDROID_BROWSER : Starting to validate user is able to place Delivery ASAP order for MCA User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(7);
		...
		components.validateCheckOutPage();
		components.enterDeliveryDetails(7);
	...
	@Test(priority = 8)
	public void TC08_ANDROID_BROWSER_DeliveryLaterTodayOrder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("DeliveryLaterTodayOrder_MCAUser_TestCase");
		log.info(
				"******TC08_ANDROID_BROWSER : Starting to validate user is able to place Delivery-Later Today for MCA user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(3);
	...
	@Test(priority = 9)
	public void TC09_ANDROID_BROWSER_PlaceOrderWithRewards_TestCase() throws Exception {
		Logger log = LogManager.getLogger("PlaceOrderWithRewards_TestCase");
		log.info(
				"******TC09_ANDROID_BROWSER : Starting to validate user is able to  place order with Rewards. For sign in user********");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(3);
	...
	@Test(priority = 10)
	public void TC10_ANDROID_BROWSER_Reorder_TestCase() throws Exception {
		Logger log = LogManager.getLogger("Reorder_TestCase");
		log.info("******TC10_ANDROID_BROWSER : Starting to validate user is able to place reorder******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(3);
	...
	@Test(priority = 11)
	public void TC11_ANDROID_BROWSER_CarryOutFutureOrder_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutFutureOrder_TestCase");
		log.info(
				"******TC11_ANDROID_BROWSER : Starting to validate user is able to place Carryout-future-date-favourite Items order for sign in user********");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(3);
	...
	@Test(priority = 12)
	public void TC12_ANDROID_BROWSER_CurbsideOrder_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbsideOrder_GuestUser_TestCase");
		log.info(
				"******TC12_ANDROID_BROWSER : Starting to validate user is able to place curbside order for Guest User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
	...
	@Test(priority = 13)
	public void TC13_ANDROID_BROWSER_DeliveryASAP_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("DeliveryASAP_GuestUser_TestCase");
		log.info(
				"******TC13_ANDROID_BROWSER : Starting to validate user is able to place Delivery-ASAP order,for Guest User******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateRestaurantSelectionforGuestUser(3);
	...
	@Test(priority = 14)
	public void TC14_ANDROID_BROWSER_deliveryLaterTodayOrder_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("deliveryLaterTodayOrder_GuestUser_TestCase");
		log.info(
				"******TC14_ANDROID_BROWSER : Starting to validate user is able to place Delivery-Later Today order, for Guest user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateRestaurantSelectionforGuestUser(3);
	...
	@Test(priority = 15)
	public void TC15_ANDROID_BROWSER_RewardsValidation_loggedInUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("RewardsValidation_loggedInUser_TestCase");
		log.info("******TC15_ANDROID_BROWSER : Starting to validate Rewards details page for logged in user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
	...
	@Test(priority = 16)
	public void TC16_ANDROID_BROWSER_ValidateLocationSearch_TestCase() throws Exception {
		Logger log = LogManager.getLogger("ValidateLocationSearch_TestCase");
		log.info(
				"******TC16_ANDROID_BROWSER : Starting to validate location search fields and links for guest user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateRestaurantSelectionforGuestUser(3);
	}
	...
	@Test(priority = 17)
	public void TC17_ANDROID_BROWSER_ValidateFavouriteItems_TestCase() throws Exception {
		Logger log = LogManager.getLogger("ValidateFavouriteItems_TestCase");
		log.info("******TC17_ANDROID_BROWSER : Starting to verify Favorites items is displaying on menu page******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
	...
	@Test(priority = 18)
	public void TC18_ANDROID_BROWSER_UpdateMyAccount_TestCase() throws Exception {
		Logger log = LogManager.getLogger("UpdateMyAccount_TestCase");
		log.info("******TC18_ANDROID_BROWSER : Starting to validate user is able to update my account******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
	...
	@Test(priority = 19)
	public void TC19_ANDROID_BROWSER_CurbsideCustomizationOrder_MCAUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CurbsideCustomizationOrder_MCAUser_TestCase");
		log.info(
				"******TC19_ANDROID_BROWSER : Starting to validate user is able to place Curbside order item customization for MCA User*******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(3);
	...
	@Test(priority = 20)
	public void TC20_ANDROID_BROWSER_CarryOutFutureCustomizedOrder_GuestUser_TestCase() throws Exception {
		Logger log = LogManager.getLogger("CarryOutFutureCustomizedOrder_GuestUser_TestCase");
		log.info(
				"******TC20_ANDROID_BROWSER : Starting to validate user is able to place Carry Out Future Customized order for guest user******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateRestaurantSelectionforGuestUser(3);
		components.selectCustomizedMenuItem();
	...
	@Test(priority = 21)
	public void TC21_ANDROID_BROWSER_AddMyVisit_TestCase() throws Exception {
		Logger log = LogManager.getLogger("AddMyVisit_TestCase");
		log.info(
				"******TC21_ANDROID_BROWSER : Starting to verify user is able to submit Add my visit form for login member******");
		FunctionalComponents components = new FunctionalComponents(driver, log);
		components.validateQASite();
		components.validateLogin();
	...
	public void TC23_ANDROID_BROWSER_QA2_LoggedInUserOrder_TestCase() throws Exception {
		...
		components.validateCheckOutPage();
		components.continueToPayment();
		components.enterPaymentDetailswithSuggestedTip(6);
		String priceBeforePlacingOrder = components.OrderTotal();
		components.placeOrder();
		components.getSuccessMessageforLoggedInOrder();
		String priceAfterPlacingOrder = components.returnOrderPrice();
	...
	public void TC24_ANDROID_BROWSER_QA2_CurbsideASAPorder_MCAUser_TestCase() throws Exception {
		...
		components.selectPickupAsap();
		components.continueToPayment();
		components.enterPaymentDetailswithCustomTip(7);
		String priceBeforePlacingOrder = components.OrderTotal();
		components.placeOrder();
		components.getSuccessMessageforLoggedInOrder();
		String priceAfterPlacingOrder = components.returnOrderPrice();
	...
	public void TC27_ANDROID_BROWSER_QA2_CarryOutASAPOrder_MCAUser_TestCase() throws Exception {
		...
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(5);
		components.validateChilisFavoriteItemsSelection(6);
		components.validateCheckOutPage();
		components.clickOnCarryOut();
		components.selectPickupAsap();
		components.continueToPayment();
		components.enterPaymentDetailswithSuggestedTip(5);
		String priceBeforePlacingOrder = components.OrderTotal();
		components.placeOrder();
		components.getSuccessMessageforLoggedInOrder();
		String priceAfterPlacingOrder = components.returnOrderPrice();
	...
	public void TC28_ANDROID_BROWSER_QA2_DeliveryASAPOrder_MCAUser_TestCase() throws Exception {
		...
		components.selectDeliveryDateASAP();
		components.continueToPayment();
		components.enterPaymentDetailswithCustomTip(6);
		String priceBeforePlacingOrder = components.DeliveryOrderTotal();
		components.placeOrder();
		components.getSuccessMessageforLoggedInOrder();
		String priceAfterPlacingOrder = components.returnDeliveryOrderPrice();
	...
	public void TC29_ANDROID_BROWSER_QA2_DeliveryLaterTodayOrder_MCAUser_TestCase() throws Exception {
		...
		components.validateQASite();
		components.validateLogin();
		components.validateRestaurantSelection(4);
		components.validateMenuItemSelection(6);
		components.validateCheckOutPage();
		components.enterDeliveryDetailsQA2(4);
		components.selectDeliveryLaterToday();
		components.continueToPayment();
		components.enterPaymentDetailswithSuggestedTip(4);
		String priceBeforePlacingOrder = components.DeliveryOrderTotal();
		components.placeOrder();
		components.getSuccessMessageforLoggedInOrder();
		String priceAfterPlacingOrder = components.returnDeliveryOrderPrice();
//		components.comparePrice(priceBeforePlacingOrder, priceAfterPlacingOrder);
	...
	public void TC30_ANDROID_BROWSER_QA2_PlaceOrderWithRewards_TestCase() throws Exception {
		...
		components.isRewardApplied();
		components.continueToPayment();
		components.enterPaymentDetailswithCustomTip(3);
		String priceBeforePlacingOrder = components.OrderTotal();
		components.placeOrder();
		System.out.println(components.getSuccessMessageforLoggedInOrder());
		String priceAfterPlacingOrder = components.returnOrderPrice();
	...
	public void TC34_ANDROID_BROWSER_QA2_DeliveryASAP_GuestUser_TestCase() throws Exception {
		...
		components.enterGuestDetails();
		components.continueToPayment();
		components.enterPaymentDetailswithSuggestedTip(3);
		String priceBeforePlacingOrder = components.DeliveryOrderTotal();
		components.placeOrder();
		System.out.println(components.getSuccessMessageforLoggedInOrder());
		String priceAfterPlacingOrder = components.returnDeliveryOrderPrice();
